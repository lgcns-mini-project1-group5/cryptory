...
public interface TrafficLogRepository extends JpaRepository<TrafficLog, Long> {
    ...
    @Query("SELECT new com.cryptory.be.admin.dto.dashboard.CoinTrafficDto(t.coin.id, t.coin.koreanName, t.coin.code, (SUM(t.pageViews) + SUM(t.users) + SUM(t.apiCalls))) " +
            "FROM TrafficLog t " +
